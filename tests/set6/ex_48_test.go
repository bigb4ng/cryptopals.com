...
type ex48Oracle struct {
	Pub  *utils.RSAPubKey
	priv *utils.RSAPrivKey
}

func NewEx48Oracle() (*ex48Oracle, error) {
	pub, priv, err := utils.GenRSAPair(768)
	if err != nil {
		return nil, err
	}
